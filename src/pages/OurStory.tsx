...
const values = [
  {
    ...
    description:
      "Working with nature, not against it. Every material choice is biodegradable and eco-conscious.",
  },
  {
    icon: Heart,
    title: "Craftsmanship",
    description:
      "Handmade by skilled artisans who've perfected the trade over generations, using techniques passed down for centuries.",
  },
  {
    icon: Scale,
    title: "Ethics",
    description:
      "We're invested in wages, advocacy, working conditions, and dignified livelihoods in the hands that make our bags.",
  },
];
    ...
    <div className="min-h-screen" style={{ backgroundColor: "#FAF8F5" }}>
      ...
      <section className="relative h-[70vh] min-h-[500px] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0">
          <img
            src={storyHero}
            alt="Ardori leather craftsmanship"
